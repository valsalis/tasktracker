...
QT_MOC_LITERAL(1, 5, 15), // "newSelectedTask"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "Task\0newSelectedTask\0"
};
...
void Task::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newSelectedTask(); break;
        default: ;
        }
        ...
        {
            using _t = void (Task::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Task::newSelectedTask)) {
                *result = 0;
                return;
            }
        }
